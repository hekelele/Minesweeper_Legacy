...
public class FrontFieldTilemap : MonoBehaviour
{
    ...
    {
        if (_MineField._FirstTime)
        {
            _MineField.makeMineField(_MineNumber, Camera.main.ScreenToWorldPoint(Input.mousePosition));
        }
    ...
    public void clearMineFiled()
    {
        ...
        for (int m = 0; m < _Xcount; m++)
        {
            ...
            {
                _FrontMap.SetTile(new Vector3Int(m, n, 0), _MarkTypes[0]);
            }
        }
    }
